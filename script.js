const skills = [
  { group: "Mobile development", items: ["Android", "iOS", "Flutter", "React Native"] },
  { group: "App development", items: ["Kotlin", "Swift", "Dart", "JavaScript", "REST APIs", "Firebase"] },
...
const projects = [
  {
    ...
    description: "Describe what the app does, who it helps, and what you built.",
    tags: ["Mobile", "Your tools"],
    link: "https://github.com/AhmadYaserOmari/Portfolio.git" // add a GitHub or store link here, e.g. "https://github.com/your-name/app"
  },
  {
    title: "Graduation project",
    description: "Add your final project from Kardan University and explain your part in it.",
    tags: ["Mobile", "Your tools"],
    link: ""
  },
  {
    title: "Your next project",
    description: "Add another app here. Delete any card you do not need.",
    tags: ["App", "Your tools"],
    link: ""
  }
];
